...
public class Olho extends JComponent {
    Point middle;
    double theta = 0;

    public Olho(int w, int h) {
        super();
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i< teeth_count; i++) {
            double a1 = angle_center - teeth_len /2;
            double a2 = angle_center + teeth_len / 2;
            ...
            t.x[1] = t.x[0] + (int)(teeth_len * Math.cos(-a1));
            t.y[1] = t.y[0] + (int)(teeth_len * Math.sin(-a1));
